...
public class ProgrammingA2Q3 {
	...
	public static void main(String[] args) throws IOException {
		...
		if (args.length < 1 || args[0].equals("help")) {
			System.err.println("Usage: ProgrammingA2Q3 <input file> <debug level>");
		...
		// Do the hash
		String hashed = ProgrammingA2Q3.hash(input.getBytes());
	...
	public static void main(String[] args) {
		String hashed = ProgrammingA2Q3.hash(args[0].getBytes());
		System.out.println("The resulting hash is: ");
		System.out.println(hashed);
	}
	*/

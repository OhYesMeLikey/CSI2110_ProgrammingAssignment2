...
// Provides the bitwise logical functions used in ProgrammingA2Q3 class
public class Logic {
	...
	public static long[][] Message(long[][] M) {
		...
		for (int i = 0; i < M.length; i++) {
			...
			for (int j = 16; j < 80; j++) {
				// Do some math from the ProgrammingA2Q3 algorithm
